    ...
    <>
      <div className="bg-[#E5E7EB]">
        <div className="flex justify-center ">
          <HomeOutlined onClick={() => navigate('/pokemon')} style={{ fontSize: "30px" }} className="mt-5" />
        </div>
        <div className="flex flex-col justify-center items-center">
          ...
          {detail?.type.slice(0, 1).map((type) => (
            <div
              className="mt-2 rounded-lg text-white text-center w-fit p-1"
              style={{
          ...
          <div className="flex justify-center items-center capitalize ">
            ...
            <div
              className="bg-[#EDEEF1]   w-[320px] p-5 rounded-lg leading-8 shadow-lg shadow-slate-300 "
                      ...
                      <div className="ml-[-5px]">
                        <div
                          ...
                          style={{
                            ...
                            boxShadow: `0 0 10px 0 ${ColorPokemon[item.type]}`,
                          }}
                        >
                          <div>
                            <img
                          ...
                          <div className="mr-2 text-white">{item.move}</div>
                        </div>
                      </div>
                    ))}
                  </div>
            ...
            <div className="bg-[#EDEEF1] w-fit p-5 w-[320px] rounded-lg flex flex-col justify-center items-center  shadow-lg shadow-slate-300">
              ...
              {detail?.type.slice(0, 1).map((type) => (
                ...
                >
                  ...
                  <div className="text-3xl mt-3">{detail?.stats.total}</div>
                </div>
              ))}
